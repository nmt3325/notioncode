...
export interface ChatResult { conversationId:string; text:string; model:string; reasoningEffort?:string|undefined; usage?:NotionUsage|undefined }
...
export interface ParsedInferenceStream { text:string; inputTokens?:number; outputTokens?:number; usage?:NotionUsage; eventTypes:Record<string,number> }
...
export type ChatJobUsage = NotionUsage
